...
//  my-swift-ui
//
//  Created by Amza Andrei on 3/28/20.
...
struct Buttons: View {
    ...
    var body: some View {
        ...
        .background(Color(#colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1)))
...
struct CircleButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack{
                LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1) : #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1)), Color(press ? #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                Circle()
            ...
            .clipShape(Circle())
            .shadow(color: Color(press ? #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1) : #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1)), radius: 20, x: -20, y: -20)
            .shadow(color: Color(press ? #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1) : #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1)), radius: 20, x: 20, y: 20)
            .scaleEffect(tap ? 1.2 : 1)
            .gesture(
...
struct PayButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack{
                LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1) : #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1)), Color(press ? #colorLiteral(red: 0, green: 1, blue: 0.9550952618, alpha: 1) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                Circle()
                    .stroke(Color.clear, lineWidth: 10)
                    .shadow(color: Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1)), radius: 3, x: -5, y: -5)
            ...
            .overlay(
                Circle()
                    ...
                    .stroke(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1)), Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing), style: StrokeStyle(lineWidth: 5, lineCap: .round))
